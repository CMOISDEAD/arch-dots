...
static int restrict_return =
    0; /* -1 option; if 1, disables shift-return and ctrl-return */
#endif // RESTRICT_RETURN_PATCH
/* -fn option overrides fonts[0]; default X11 font or font set */
#if PANGO_PATCH
static char font[] = "AestheticIosevka Nerd Font Mono 10";
#else
#if XRESOURCES_PATCH
static char *fonts[] =
#else
static const char *fonts[] =
    ...
    {"AestheticIosevka Nerd Font Mono:size=10"};
#endif // PANGO_PATCH
#if MANAGED_PATCH
