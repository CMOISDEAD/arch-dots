...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.cargo/bin:$HOME/.tmuxifier/bin/:$HOME/.dotnet/tools:$PATH

export EDITOR=nvim # Use neovim as the default editor
export ZSH="$HOME/.oh-my-zsh" # Path to your oh-my-zsh installation.
export ZSH_TMUX_AUTOSTART=true # Tmux auto start
...
alias l="exa -l --header --git --icons -s type"
alias ll="exa -la --header --git --icons -s type"

alias wallpaper="~/.fehbg"
